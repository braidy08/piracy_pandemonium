Hooks:PostHook(TweakData, "_setup_point_of_no_returns", "priacy_pandemonium_ponr", function(self)
	self.point_of_no_returns.baindroppedofroof = {
		...
		scale_box = true,
		text_id = "hud_assault_point_no_holyshityoudroppedbain"
	}
	self.point_of_no_returns.PP_OMGGETTHEHELLOUT = {
		color = Color(1, 1, 0, 0),
		timer_flash_color = Color(1, 1, 0.8, 0.2),
		attention_color = Color(1, 1, 1, 1),
		scale_box = true,
	...
	self.point_of_no_returns.PP_ExplodeSafehouse = {
		color = Color(1, 1, 0, 0),
		timer_flash_color = Color(1, 1, 0.8, 0.2),
		attention_color = Color(1, 1, 1, 1),
		scale_box = true,
		text_id = "hud_assault_point_no_PP_ExplodeSafehouse"
	}
end)
